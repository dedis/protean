...
#python3.11 process_data.py ../randlottery/test_data/save/randlot_multi.csv rlot -m
#python3.11 process_data.py ../dkglottery/test_data/save/dkglot_multi.csv dlot -m
#python3.11 process_data.py ../evoting/test_data/save/ev_multi.csv evote -m
